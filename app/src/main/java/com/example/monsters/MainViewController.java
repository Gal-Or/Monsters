...
public class MainViewController {
    ...
    final int DELAY = 1400; // 1400ms = 1.4 second
    ...
    private void findViews() {
        ...
        girl_score=0;
        boy_score=0;
        main_IMG_girl_monster = activity.findViewById(R.id.main_IMG_girl_monster);
        main_IMG_boy_monster = activity.findViewById(R.id.main_IMG_boy_monster);
        main_BTN_blades = (ImageButton)activity.findViewById(R.id.main_BTN_blades);
        initMonsters();
        gson = new Gson();
    }
    ...
    private void initViews() {
        // set background and button with glide
        activity.updateImage(activity.getResources().getIdentifier("forest", "drawable", activity.getPackageName()), main_IMG_background);
        activity.updateImage(activity.getResources().getIdentifier("blades", "drawable", activity.getPackageName()), main_BTN_blades);
    ...
    private void playTurn() {
        ...
        if(girl_monster>boy_monster) //girl wins this turn
            main_LBL_girl_score.setText(++girl_score+"");
        else //boy wins this turn
            main_LBL_boy_score.setText(++boy_score+"");

        //remove monsters from array
