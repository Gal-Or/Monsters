...
public class Activity_Winner extends Activity_Base {
    ...
    private Button winner_BNT_topTen;
    ...
    private void findViews() {
        ...
        winner_BNT_topTen=findViewById(R.id.winner_BTN_topTen);
    ...
    private void initViews() {
        ...
        winner_BNT_topTen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                playSound(R.raw.snd_bubble);
    ...
    private  void addAndSaveToTopTen(){ // add winner to top ten (if needed) and save top ten to memory
